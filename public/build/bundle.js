...
var app = (function () {
    ...
    /* src/Meetups/MeetupGrid/MeetupGrid.svelte generated by Svelte v3.56.0 */
    const file = "src/Meetups/MeetupGrid/MeetupGrid.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 20, 0, 314);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	meetupgrid = new MeetupGrid({ props: { meetups }, $$inline: true });
