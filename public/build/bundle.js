...
var app = (function () {
    ...
    /* src/UI/Header/Header.svelte generated by Svelte v3.56.0 */

    const file$2 = "src/UI/Header/Header.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-upbb7b");
    			add_location(h1, file$2, 22, 2, 350);
    			attr_dev(header, "class", "svelte-upbb7b");
    			add_location(header, file$2, 21, 0, 339);
    		},
    ...
    /* src/Meetups/MeetupItem/MeetupItem.svelte generated by Svelte v3.56.0 */
    const file$1 = "src/Meetups/MeetupItem/MeetupItem.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 8, 4, 95);
    			add_location(h2, file$1, 9, 4, 123);
    			add_location(p0, file$1, 10, 4, 154);
    			add_location(header, file$1, 7, 2, 82);
    			...
    			add_location(img, file$1, 13, 4, 216);
    			attr_dev(div0, "class", "image");
    			add_location(div0, file$1, 12, 2, 192);
    			add_location(p1, file$1, 16, 4, 304);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 15, 2, 278);
    			attr_dev(a, "href", a_href_value = "mailto:" + /*meetup*/ ctx[0].email);
    			add_location(a, file$1, 19, 4, 356);
    			add_location(button0, file$1, 20, 4, 404);
    			add_location(button1, file$1, 21, 4, 438);
    			add_location(footer, file$1, 18, 2, 343);
    			add_location(article, file$1, 6, 0, 70);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const meetups = [
      {
        id: 'm1',
        title: 'Dev Web Conference',
        subtitle: 'Aprenda novas tecnologias e networking',
      ...
      },
      {
        id: 'm2',
        title: 'Hackathon Web',
        subtitle: 'Uma competição para desenvolvedores',
      ...
      },
      {
        ...
        subtitle: 'Melhore suas habilidades de design',
      ...
      },
      {
        ...
        subtitle: 'Venha aprender e compartilhar conhecimentos sobre React',
      ...
      },
      {
        ...
        subtitle: 'Aprenda a desenvolver interfaces incríveis',
      ...
      },
      {
        id: 'm6',
        title: 'DevOps Meetup',
        subtitle: 'Conheça as melhores práticas de DevOps',
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:0) {#each meetups as meetup}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-i3vnzl");
    			add_location(section, file, 16, 0, 249);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
